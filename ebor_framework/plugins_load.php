...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'slug'     				=> 'ebor-cpt', // The plugin slug (typically the folder name)
		...
		array(
			...
			'slug'     				=> 'Ebor-Shortcodes', // The plugin slug (typically the folder name)
		...
		array(
			...
			'slug'     				=> 'Ebor-Popular-Posts', // The plugin slug (typically the folder name)
	 ...
	 */
	$config = array(
		'domain'       		=> 'marble',         	// Text domain - likely want to be the same as your theme.
		...
		'strings'      		=> array(
			...
			'installing'                       			=> __( 'Installing Plugin: %s', 'marble' ), // %1$s = plugin name
			'oops'                             			=> __( 'Something went wrong with the plugin API.', 'marble' ),
			...
			'complete' 									=> __( 'All plugins installed and activated successfully. %s', 'marble' ), // %1$s = dashboard link
